...
parser.add_argument('--feature_image', dest='feature_image', default='/media/nsh/subdisk1/2nd_experiment/network/age_estimation/MORPH/1_VGG16/enhanced/test_90/336345_00M41.JPG', help='test data labels')
...
parser.add_argument('--checkpoint', dest = 'checkpoint', default='train1_high/cp-{epoch:03d}.ckpt', help='checkopint')
